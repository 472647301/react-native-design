package byron.design.wheelpicker.widgets;
...
import byron.design.wheelpicker.model.City;
import byron.design.wheelpicker.model.Province;
...
public class WheelAreaPicker extends LinearLayout implements IWheelAreaPicker {
    ...
    private void initWheelPicker(WheelPicker wheelPicker, float weight) {
        ...
        wheelPicker.setItemTextSize(dip2px(mContext));
    ...
    private int dip2px(Context context) {
        ...
        return (int) (WheelAreaPicker.ITEM_TEXT_SIZE * scale + 0.5f);
    }
